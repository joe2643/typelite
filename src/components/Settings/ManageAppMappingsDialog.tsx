  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-5">
      ...
      <div
        ...
        className="relative z-10 flex max-h-[72vh] w-full max-w-[460px] flex-col dialog"
      >
        ...
        <div className="min-h-0 overflow-y-auto px-4">
          {rows.length === 0 ? (
            ...
            rows.map((mapping) => (
              <div
                key={mapping.id}
                className="flex min-w-0 items-center gap-2 border-b border-hairline py-2.5 last:border-b-0"
              >
