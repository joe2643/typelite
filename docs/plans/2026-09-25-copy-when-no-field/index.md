# 0018 — Copy pill when there is nowhere to paste
...
| Hover pauses the countdown; Esc closes; Copy writes the full result, shows "Copied", hides after about 1 s | Time to read and act; the existing Escape handling from 0016 is reused. |
